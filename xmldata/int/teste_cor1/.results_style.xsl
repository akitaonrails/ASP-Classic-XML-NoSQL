...
<xsl:template match="table">
            <table width="450" border="0" cellspacing="0" cellpadding="3" height="30">
              <tr> 
                <td width="110">
                  <div align="center"><img src="imgs/data.gif" width="27" height="6"></div>
                </td>
                <td width="350"> 
                  <div align="center"><img src="imgs/resultados2.gif" width="67" height="6"></div>
                </td>
              </tr>
            </table>
...
<xsl:template match="item">
              <tr bgcolor="#333333" align="center" valign="middle"> 
                ...
                <td width="150" class="texto_resultados" align="left"><xsl:value-of select="goalsVisitor" /></td>
              </tr>
</xsl:template>
